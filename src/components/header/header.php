...
<? if ($HEADER_ABSOLUTE === true) { echo 'godere-header_absolute'; }; ?>'>
    ...
    <div class='godere-header__sub'>
      <a href="#" class='godere-header__search'>
      ...
      <a href='/cart' class='godere-header__cart'>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class='godere-header__count'>22</div>
      </a>
      <div class='godere-header__hamburger' id='hamburger'>
        <span></span>
        <span></span>
        <span></span>
      </div>
