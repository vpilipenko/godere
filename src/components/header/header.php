...
<? if ($HEADER_DARK === true) { echo 'godere-header_dark'; }; ?> 
<? if ($HEADER_ABSOLUTE === true) { echo 'godere-header_absolute'; }; ?>'>
  <div class='container godere-header__container'>
    ...
    <nav class='godere-nav'>
      ...
      <div class='godere-nav__pane godere-nav__pane_personal' id='cabinetPane'>
        ...
        <a href='#' class='godere-nav__link'>Заказы</a>
        <a href='#' class='godere-nav__link'>Бонусы</a>
        <a href='#' class='godere-nav__link'>Выход</a>
      </div>
    </nav>

    <div class='godere-header__sub'>
      <div class='godere-header__search'>
      ...
      <div class='godere-header__cart'>
        ...
        <div class='godere-header__count'>
        </div>
      </div>
      <div id='hamburger'>
        <span></span>
